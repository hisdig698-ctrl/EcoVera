      ...
      <div className="pt-28 pb-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            {/* Product Image */}
            <div className="relative aspect-square rounded-3xl overflow-hidden bg-card ecovera-shadow">
              <Image
            ...
            <div className="flex flex-col">
                ...
                <div className="flex gap-3">
                  {product.sizes.map((size) => (
                    <button
                      ...
                      className={`px-6 py-3 rounded-full text-sm ecovera-transition ecovera-shadow ${selectedSize === size
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
                {benefits.map((benefit) => (
                  <div
                    key={benefit.label}
                    className="flex flex-col items-center gap-2 p-4 ecovera-shadow bg-transparent shadow-none rounded-md"
                  >
